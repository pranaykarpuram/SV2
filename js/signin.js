class Signin{
    ...
    display(){
        ...
        this.prescriptions3.show();
        this.prescriptions3.position(width*3/4, height*600/1250);
        if(this.prescriptions3.checked()){
            data.tablet3 = "Prescribed";
        }
        else{
            data.tablet3 = null;
        }

        this.prescriptions4.show();
        this.prescriptions4.position(width*3/4, height*700/1250);
        if(this.prescriptions4.checked()){
            data.tablet4 = "Prescribed";
        }
        else{
            data.tablet4 = null;
        }

        this.prescriptions5.show();
        this.prescriptions5.position(width*3/4, height*800/1250);
        if(this.prescriptions5.checked()){
            data.tablet5 = "Prescribed";
        }
        else{
            data.tablet5 = "Not Prescribed";
        }
